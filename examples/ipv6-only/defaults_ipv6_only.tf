...
output "vpc_ipv6_cidr_block" {
  value = module.aws_defaults.vpc_ipv6_cidr_block
}

output "vpc_public_subnet_ipv6_cidr_blocks" {
  value = module.aws_defaults.vpc_public_subnet_ipv6_cidr_blocks
}

output "vpc_private_subnet_ipv6_cidr_blocks" {
  value = module.aws_defaults.vpc_private_subnet_ipv6_cidr_blocks
}

output "vpc_egress_only_internet_gateway_id" {
  value = module.aws_defaults.vpc_egress_only_internet_gateway_id
}
